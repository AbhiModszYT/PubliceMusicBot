...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("PubliceMusicBot/assets/font2.ttf", 30)
    font = ImageFont.truetype("PubliceMusicBot/assets/font.ttf", 30)
    title_font = ImageFont.truetype("PubliceMusicBot/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("PubliceMusicBot/assets/play_icons.png")
